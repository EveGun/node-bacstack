...
const encodeBacnetObjectId = (module.exports.encodeBacnetObjectId = (
  buffer,
  objectType,
  instance
) => {
...
const encodeTag = (module.exports.encodeTag = (
  buffer,
  tagNumber,
  contextSpecific,
  lenValueType
...
const encodeContextUnsigned = (module.exports.encodeContextUnsigned = (
  buffer,
  tagNumber,
  value
) => {
...
const encodeContextEnumerated = (module.exports.encodeContextEnumerated = (
  buffer,
  tagNumber,
  value
) => {
...
const encodeApplicationOctetString = (module.exports.encodeApplicationOctetString = (
  buffer,
  octetString,
  octetOffset,
  octetCount
...
const encodeApplicationBoolean = (module.exports.encodeApplicationBoolean = (
  buffer,
  booleanValue
) => {
...
const encodeApplicationObjectId = (module.exports.encodeApplicationObjectId = (
  buffer,
  objectType,
  instance
) => {
...
const encodeApplicationEnumerated = (module.exports.encodeApplicationEnumerated = (
  buffer,
  value
) => {
  const tmp = getBuffer();
...
const encodeApplicationBitstring = (module.exports.encodeApplicationBitstring = (
  buffer,
  bitString
) => {
...
const encodeContextObjectId = (module.exports.encodeContextObjectId = (
  buffer,
  tagNumber,
  objectType,
  instance
...
const encodeReadAccessSpecification = (module.exports.encodeReadAccessSpecification = (
  buffer,
  value
) => {
...
const encodeContextBoolean = (module.exports.encodeContextBoolean = (
  buffer,
  tagNumber,
  booleanValue
) => {
...
const bacappEncodeApplicationData = (module.exports.bacappEncodeApplicationData = (
  buffer,
  value
) => {
  if (value.value === null) {
...
const bacappEncodeContextDeviceObjPropertyRef =
...
const encodeContextBitstring = (module.exports.encodeContextBitstring = (
  buffer,
  tagNumber,
  bitString
) => {
...
const decodeIsOpeningTagNumber = (module.exports.decodeIsOpeningTagNumber = (
  buffer,
  offset,
  tagNumber
) => {
...
const decodeIsClosingTagNumber = (module.exports.decodeIsClosingTagNumber = (
  buffer,
  offset,
  tagNumber
) => {
...
const bacappDecodeApplicationData = (module.exports.bacappDecodeApplicationData = (
  buffer,
  offset,
  maxOffset,
  objectType,
...
const decodeReadAccessResult = (module.exports.decodeReadAccessResult = (
  buffer,
  offset,
  apduLen
) => {
  ...
  while (apduLen - len > 0) {
    ...
    if (result.tagNumber === 4) {
      ...
      while (len + offset <= buffer.length && !decodeIsClosingTagNumber(buffer, offset + len, 4)) {
        let localResult = bacappDecodeApplicationData(
          buffer,
          offset + len,
          apduLen + offset - 1,
          value.objectId.type,
...
const decodeOctetString = (module.exports.decodeOctetString = (
  buffer,
  offset,
  maxLength,
  octetStringOffset,
...
const decodeCharacterString = (module.exports.decodeCharacterString = (
  buffer,
  offset,
  maxLength,
  lenValue
...
const decodeReadAccessSpecification = (module.exports.decodeReadAccessSpecification = (
  buffer,
  offset,
  apduLen
) => {
...
const bacappDecodeContextApplicationData = (buffer, offset, maxOffset, objectType, propertyId) => {
  ...
  if (isContextSpecific(buffer[offset])) {
    if (propertyId === baEnum.PropertyIdentifier.LIST_OF_GROUP_MEMBERS) {
      ...
      propertyId === baEnum.PropertyIdentifier.LIST_OF_OBJECT_PROPERTY_REFERENCES ||
      propertyId === baEnum.PropertyIdentifier.LOG_DEVICE_OBJECT_PROPERTY ||
    ...
    while (len + offset <= maxOffset && !isClosingTag(buffer[offset + len])) {
      ...
      if (subResult.value === 0) {
        len += subResult.len;
        result = bacappDecodeApplicationData(
          buffer,
          offset + len,
          maxOffset,
        ...
        let bacappResult = bacappDecodeData(
          buffer,
...
const bacappEncodeContextTimestamp = (module.exports.bacappEncodeContextTimestamp = (
  buffer,
  tagNumber,
  value
) => {
...
const decodeContextCharacterString = (module.exports.decodeContextCharacterString = (
  buffer,
  offset,
  maxLength,
  tagNumber
...
const encodeApplicationCharacterString = (module.exports.encodeApplicationCharacterString = (
  buffer,
  value,
  encoding
) => {
...
const encodeContextCharacterString = (module.exports.encodeContextCharacterString = (
  buffer,
  tagNumber,
  value,
  encoding
...
const decodeCalendarDatelist = (module.exports.decodeCalendarDatelist = (
  buffer,
  offset,
  apduLen
) => {
  ...
  while (len < apduLen && !decodeIsClosingTagNumber(buffer, offset + len, 3)) {
    ...
    console.log(value);
    throw new Error('BACnet calendar can not be parsed yet');
    break;
  }
  len++;
  return { len: len, values: Object.values(result) };
